...
class WebHook(_PluginBase):
    ...
    def init_plugin(self, config: dict = None):
        ...
        if config:
            ...
            self.x_gewe_token = config.get("x_gewe_token")
            self.app_id = config.get("app_id")
            self.to_wxid = config.get("to_wxid")
...
def get_form(self) -> Tuple[List[dict], Dict[str, Any]]:
 ...
 def process_queue(self):
        ...
        while True:
            ...
            try:
                headers = {
                    "X-GEWE-TOKEN": self.x_gewe_token
                }
                data = {
                    "appId": self.app_id,
                    "toWxid": self.to_wxid,
                ...
                sc_url = self.post_url
                res = RequestUtils().post_res(sc_url, headers=headers, json=data)
